...
subtitle: "Assumption-Free Exact Matching Inference in a Large Population of Data"  
...
Thank to Royce, Ryan, Carolina, Alex, and everyone involved that decided to honor Harold with this series; it is a testament to him, his contributions to Essex, the Summer School, and the discipline and to what great people you all are.
...
- Harold was my teacher, my friend, one of my mentors, my co-teacher, my collaborator, and the reason, quite literally, that I became a political scientist.  I am honored to give this.  I hope he would approve.....  
...
+ The design:
   - eliminates uncertainty due to sampling variation, given that we have the population of *unclassified* data.
   - focuses us on the uncertainty surrounding which employees to compare in our analysis. 
   
+ We replicate prior evidence and media accounts that preference beneficiaries possess weaker educational credentials than non-recipients.  
...
+ **Takeaway: The assessment of perceptions of hiring quality requires careful attention to the appropriate basis for comparing employees.**
...
Quite frankly, we have both positive and normative motivations that we should lay bare.  The topic is of both public and academic interest.[^1]
...
- Johnson and Walker (2018) uses pay grade and pay increase data to show equivalent advancement tendencies for preference recipients and non-recipients when entry positions are rendered comparable.
...
Notes: The y-axis is censored at 200.
The result from this is the top row of the next table.
